...
var map; 
	...
	function initialize(source/*archivo xml*/, target/*capa en la que se cargaran los datos tabulados*/, del /*op eliminar*/) {
	  if (GBrowserIsCompatible()) {
		...
		document.getElementById('precarga').innerHTML = 'Cargando Puntos Cienaga de mallorquin.....';
			  ...
			  for (var i = 0; i < records.length; i++) {
				 ...
				 /* var obama = parseInt(rec.getAttribute("Obama"));
				  ...
				  map.addOverlay(poly);
					...
					document.getElementById('precarga').innerHTML = 'Cienaga de Mallorquin: <strong>'+ contador + '</strong> Poligonos y <strong>'+ npuntos+'</strong> Puntos Cargados';
