...
<html>
<head>
<title>POMCA Rio Magdalena</title>
...
<script src="js/zonas_riomagdalena.js" language="javascript"></script>
...
<!-- Contenido de la estructura -->	
	<div id="content-wrap">
		<div id="main">
				...
				<div align="center"><strong>RIO MAGDALENA</strong></div><br/>
				  <table>
					<tr><td colspan="2"><div align="center"><strong>Convenciones</strong></div></td>
					</tr>
					<tr><td>CP</td><td><img src="img/convenciones/CP.png"/></td></tr>
					<tr><td>ZEE</td><td><img src="img/convenciones/ZEE.png" alt="Zona Ecosistema Estrategico"/></td></tr>
					...
					<tr><td>ZRP</td><td><img src="img/convenciones/ZRP.png"/></td></tr>
